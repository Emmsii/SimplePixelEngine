...
//        wall3 = Sprite.cutFromSpritesheet(sheet, 2, 2, 16, 16).overrideColors(-1, -1);
    ...
    public boolean update(Input input) {
        ...
        mx = input.getMouseX();
        my = input.getMouseY();
        msx = input.getScaledMouseX();
        msy = input.getScaledMouseY();
...
//
        ...
        renderer.write(mx + "," + my, font, 5, 5, 0xff0000);
        renderer.write(msx + "," + msy, font, 5, 15, 0xff0000);
        renderer.write(mtx + "," + mty, font, 5, 25, 0xff0000);
//
